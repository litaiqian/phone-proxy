...
data class BindAccount(
    ...
    @SerializedName("bid_result") val bidResult: String = "",
    @SerializedName("pay_status") val payStatus: String = "",
    @SerializedName("pay_url") val payUrl: String = "",
    @SerializedName("pay_url_wechat") val payUrlWechat: String = "",
    @SerializedName("pay_url_alipay") val payUrlAlipay: String = ""
)
