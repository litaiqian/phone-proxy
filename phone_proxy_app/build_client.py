...
def build_exe(user_id: int, server: str = 'http://ipla.top:5000',
    ...
    source = source.replace('BRIDGE_BASE_URL = "http://ipla.top:8000"', f'BRIDGE_BASE_URL = "{bridge}"')
...
示例:
  ...
  python build_client.py --all
    ...
    parser.add_argument('--bridge', default='http://ipla.top:8000', help='桥接地址')
